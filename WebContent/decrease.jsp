...
<body>
<h1>Update Price</h1>
		<form action="decrease.jsp">
				<input type="text" name="vname" placeholder=" Enter Vaccine Name ">
				<input type="text" name="decreaseamt" placeholder=" Enter amount to decrease ">
				<input type="submit" value="Submit">
		</form>
		<%
		try
		{
			String decreaseamt=request.getParameter("decreaseamt");
			String vname=request.getParameter("vname");
				...
				float amt=Float.parseFloat(decreaseamt);
				if(rs.next())
				{
